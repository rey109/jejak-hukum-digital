        ...
        <div className="space-y-8">
          {content.points.map((point: any, index: number) => (
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 cursor-pointer hover:bg-white/15 transition-all group"
            >
              <h3 className="text-2xl font-bold text-[#d4af37] mb-4 group-hover:text-yellow-300 transition-colors">
                {point.title}
              </h3>
              ...
              <div className="mt-4 flex items-center text-blue-200 group-hover:text-white transition-colors">
                <span className="text-sm">Klik untuk melihat contoh</span>
